<template>
  <div class="inline relative" @mouseenter="isHovering = true" @mouseleave="isHovering = false">
    ...
    <category-list v-show="isHovering" :current-page="currentPage" classes="absolute top-4 right-0 lg:-right-4 z-10 bg-menu-light dark:bg-menu-dark hover:shadow-lg hover:rounded-none max-h-[33vh] overflow-y-scroll" />
  </div>
</template>

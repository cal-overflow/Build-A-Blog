  ...
  <div class="m-6 p-6 bg-gray-100 shadow-md hover:shadow-none hover:rounded motion-safe:animate-fade-in-fast">
    <form  @submit.prevent="openMail">
      <div class="flex flex-wrap md:flex-nowrap">
        <div :class="`w-full ${isError ? 'md:w-1/2' : 'md:w-2/3'} p-6 mx-auto`">
          ...
          <input
            ...
            name="name"
            required
            class="w-full px-4 py-2 bg-gray-200 rounded-lg"
          />
          ...
          <div v-if="!isError">
            ...
            <textarea
              ...
              class="w-full h-32 resize-none px-4 py-2 bg-gray-200 rounded-lg"
            />
          </div>
        ...
        <div v-if="isError" class="w-full md:w-1/2 mx-auto p-6 mx-auto">
          ...
          <p class="text-xs text-gray-600">This information was generated by the error you received.</p>
          <div v-if="$route.query.statusCode">
            ...
            <input
              ...
              disabled
              class="w-full px-4 py-2 bg-gray-100 bg-gray-200 border-gray-300 border-2 rounded-lg"
            />
          </div>
          ...
          <div v-if="$route.query.detail">
            ...
            <textarea
              ...
              disabled
              class="w-full h-32 resize-none px-4 py-2 bg-gray-200 border-gray-300 border-2 rounded-lg"
            />
          </div>
        </div>
      </div>
      ...
      <div :class="`${!isError ? 'md:w-2/3' : ''} mx-auto p-6`">
        ...
        />
        <p :class="`text-xs text-gray-600 transition-opacity duration-1000 ${name || topic || message || extraFeedback ? 'opacity-1' : 'opacity-0'}`">

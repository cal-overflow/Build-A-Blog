    ...
    <div class="max-w-screen-lg mx-auto">
      <div class="flex bg-gray-100 m-6 p-4 flex-wrap md:flex-nowrap shadow-lg hover:shadow-none hover:rounded">
          ...
          <div class="md:w-3/5 lg:w-2/3 m-4 xs:mb-12 md:mb-0">
            ...
            <p class="mb-4">If you have any questions while viewing my website or want to get in touch, please feel free to <a href="/contact" class="text-primary-red underline">reach out to me</a>.</p>
          </div>
        </div>
    </div>

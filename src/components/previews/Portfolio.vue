<template>
  <div class="bg-card-light dark:bg-card-dark text-center m-6 p-6 md:w-1/2 hover:rounded shadow-md dark:shadow-shadow-dark hover:shadow-none">
    ...
    <nav-item title="View my work" href="/category/portfolio" class="text-primary-light dark:!text-primary-dark underline hover:no-underline" />
  </div>
</template>

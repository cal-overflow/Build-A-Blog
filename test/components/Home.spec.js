...
describe('Home component', () => {
  ...
  it('contains the correct text', () => {
    ...
    expect(wrapper.text()).toContain("I’m not one for writing an extensive bio; besides, I think a lot of my work speaks for itself. Have a look around my portfolio to get a good sense of the kind of work I do.");
